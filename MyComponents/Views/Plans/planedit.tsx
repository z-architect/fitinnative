      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.planmetacontainer}>
          ...
          <View>
            ...
            >
              <Radio accessibilityLabel="favorite number" value="Losing Weight">
                {" "}
                Losing Weight{" "}
              </Radio>
              <Radio accessibilityLabel="favorite number" value="Bulking Up">
                {" "}
                Bulking Up{" "}
              </Radio>
              <Radio accessibilityLabel="favorite number" value="Athleticism">
                {" "}
                Athleticism{" "}
              </Radio>
              <Radio accessibilityLabel="favorite number" value="Maintenance">
                {" "}
                Maintenance{" "}
              </Radio>
            </Radio.Group>
        ...
        <View style={styles.sessioncontainerheader}>
          <Text style={{ fontSize: 26 }}>Plan Sessions</Text>
        </View>
