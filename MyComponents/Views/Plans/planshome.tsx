      ...
      >
        ...
        >
          <View style={[styles.textContainer, { paddingVertical: 0 }]}>
            ...
            >
              {strings[language].featuredPlans}
            </Text>
            <TouchableOpacity
              onPress={() => {
        ...
        (!meal && !!currentPlans?.activity) ? (
          ...
          >
            <Text style={{ fontSize: 16 }}>
              {strings[language].youarenotfollowinganyplans}
            </Text>
