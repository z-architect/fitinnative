...
const MealSession = ({ navigation, route }: Props) => {
                    ...
                    <Modal.Body>
                        {
                            UnselectedConstituents.map((data, i) => (
                                <Constituents key={i} data={data} onTouch={() => { addSet(data) }} deleteSet={() => { deleteUnselectedSet(data.id) }} editSet={() => { setShowModal(false); navigation.navigate("ConstituentEdit") }} />
                            ))
                        }
                    </Modal.Body>
                    <Modal.Footer>
